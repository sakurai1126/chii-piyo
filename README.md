...
## 開発背景
子供の写真を家族間で共有するにあたり、無料で使い勝手の良いアプリがなかなか見つからなかったことが出発点。

特に祖父母世代との共有では、既存アプリの操作が複雑で定着しづらいという課題があった。
その一方で自分たち親世代は育児記録やアルバム管理など、より高機能なツールを求めていた。

「祖父母にはシンプルに、親世代には高機能に」という相反する要件を両立させるには既製品では限界があると感じ、オーダーメイドで自作する方針を選択。

また、子供の成長に合わせて今後も新しい要件が出てくることが想定されるため、その都度機能を拡張していくことで家族にとって本当に使いやすいアプリを長期的に育てていくと同時に自身の技術力向上も継続できると考えている。
