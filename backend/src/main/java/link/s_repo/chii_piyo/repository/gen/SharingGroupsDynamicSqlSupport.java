...
public final class SharingGroupsDynamicSqlSupport {
    ...
    public static final SqlColumn<OffsetDateTime> createdAt = sharingGroups.createdAt;

    public static final SqlColumn<OffsetDateTime> updatedAt = sharingGroups.updatedAt;
