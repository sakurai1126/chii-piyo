...
export const ActionDialog = ({ children, onClose }: Props) => {
  return (
    <div className="grid h-screen w-screen place-content-center">
      <div className="bg-white-back border-brown-dark mx-auto min-h-75 w-[calc(100vw-40px)] max-w-175 rounded-lg border p-10 max-md:min-h-0 max-md:p-5 max-md:pb-9">
        <button
