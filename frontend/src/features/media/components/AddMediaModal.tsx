        ...
        {isOpen && (
          <Modal>
            <div className="grid h-screen w-screen place-content-center">
              <div className="bg-background-light border-brown-dark relative mx-auto h-[85vh] w-[calc(100vw-40px)] max-w-250 overflow-y-scroll rounded-lg border p-10 max-md:min-h-0 max-md:p-5 max-md:pb-9">
                ...
                <button
                  ...
                  className="text-brown-dark border-brown-dark bg-background-dark mt-7 flex w-full items-center justify-center gap-2 rounded-lg border py-5 text-[13px] outline-0 md:hidden"
                >
