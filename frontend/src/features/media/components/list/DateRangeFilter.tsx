  ...
  return (
    <div className="bg-background-dark shrink-0 rounded-lg px-7 pt-6 pb-8 max-md:p-3 max-md:pb-4">
      ...
      <div className="mt-3 flex items-center gap-2">
        <input
          type="date"
          className={`focus:outline-brown-light border-line-gray bg-light-dark h-9 w-35 rounded-sm border px-3 text-sm max-md:h-9 max-md:w-[calc(50%-15px)] max-md:text-xs ${currentStartDate ? "" : "text-line-gray"}`}
        ...
        <input
          type="date"
          className={`focus:outline-brown-light border-line-gray bg-light-dark h-9 w-35 rounded-sm border px-3 text-sm max-md:h-9 max-md:w-[calc(50%-15px)] max-md:text-xs ${currentEndDate ? "" : "text-line-gray"}`}
