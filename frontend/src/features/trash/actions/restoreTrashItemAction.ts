...
export const restoreTrashItemAction = async (input: Input): Promise<ActionResult> => {
  try {
    ...
    console.error("restoreTrashItemAction失敗", error);
