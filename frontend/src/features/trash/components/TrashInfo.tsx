...
export const TrashInfo = ({ trashItems }: Props) => {
  return (
    <>
      ...
      <div className="bg-background-dark border-brown-middle mt-7.5 flex items-center gap-4 rounded-lg border p-5 max-md:mt-6 max-md:items-start max-md:gap-3 max-md:p-3">
